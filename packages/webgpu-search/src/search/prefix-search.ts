 ...
 * lands with custom tokenizer hooks).
 *
 ...
 *
 * Portable: no DOM refs. Operates on post-normalization u32 token streams; shares
 ...
 * (see exact-scorer.ts). Note: a fixed `prefixLength` with a shorter
