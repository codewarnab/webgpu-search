...
export const CORE_FILES: MonacoFileRecord[] = [
  ...
  {
    id: 'f-006',
    path: 'packages/webgpu-search/src/persistence.ts',
    filename: 'persistence.ts',
    symbols: 'serializeDocumentIndex, restoreDocumentIndex, deserializeDocumentSnapshot, crc32Parts',
    type: 'function',
    language: 'typescript',
    description: 'Versioned Little-Endian U2D3 binary persistence with circular-dependency-free CRC32',
    sizeBytes: 21400,
    lineCount: 560
  },
  {
    id: 'f-007',
    path: 'packages/webgpu-search/src/idb-storage.ts',
    filename: 'idb-storage.ts',
  ...
  {
    id: 'f-011',
    path: 'packages/webgpu-search/src/cpu-reference.ts',
    filename: 'cpu-reference.ts',
    symbols: 'searchCpuReference, searchMultiFieldCpuReference, scoreFuzzyTokens, scoreSubstringTokens',
    type: 'function',
    language: 'typescript',
  ...
  {
    id: 'f-012',
    path: 'packages/webgpu-search/src/unicode-preprocess.ts',
    filename: 'unicode-preprocess.ts',
