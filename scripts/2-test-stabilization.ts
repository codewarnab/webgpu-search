...
async function runMockTests() {
    console.log('--- Running WebGPU Stabilization Regression Tests ---');
    ...
    console.log('13. Testing concurrent searches and CPU fallback paths...');
    ...
    console.log('   ✅ Concurrent searches stay isolated; GPU query errors fall back to CPU');
